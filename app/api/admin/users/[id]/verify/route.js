...
// ── PATCH: suspend / unsuspend / delete ──────────────────────────────────
// Called by the admin dashboard's handleUserAction(userId, action, reason)
export async function PATCH(request, { params }) {
  try {
    ...
    // Prevent an admin from suspending/deleting another admin (including themselves)
    if (user.role === 'admin') {
